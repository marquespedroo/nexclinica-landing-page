...
const ProblemSection: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-screen bg-gradient-to-b from-black via-red-950/10 to-black py-24 overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          {painPoints.map((point, i) => (
            <div
              key={i}
              className={`p-6 rounded-2xl bg-white/5 border border-red-500/10 backdrop-blur-sm hover:border-red-500/30 transition-all duration-500 group ${
